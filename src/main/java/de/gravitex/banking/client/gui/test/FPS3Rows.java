...
public class FPS3Rows extends FPS {
	...
	public FPS3Rows(List<FpsMoo> aMoos) {
		super(aMoos);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//---- label1 ----
		add(new JLabel("Klapp 74356rhtrht"), new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
		...
		//---- label2 ----
		add(new JLabel("Klapp"), new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
			GridBagConstraints.CENTER, GridBagConstraints.BOTH,
			new Insets(0, 0, 5, 5), 0, 0));
		...
		//---- label3 ----
		add(new JLabel("Klapp 1234"), new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
			GridBagConstraints.CENTER, GridBagConstraints.BOTH,
			new Insets(0, 0, 5, 5), 0, 0));
		...
		//---- button1 ----
		add(new JButton("OK"), new GridBagConstraints(0, 4, 2, 1, 0.0, 0.0,
			GridBagConstraints.CENTER, GridBagConstraints.BOTH,
